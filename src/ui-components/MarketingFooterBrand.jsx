    ...
    >
      ...
      >
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Ayush Industries "
          {...getOverrideProps(overrides, "Ayush Industries")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="© 2024 Ayush InfoTech. Pvt. Ltd.I. All rights reserved."
          {...getOverrideProps(
            overrides,
            "\u00A9 2024 Ayush InfoTech. Pvt. Ltd.I. All rights reserved."
          )}
        ></Text>
      </Flex>
    </Flex>
